...
const AcceptedInsurances = () => {
  ...
  const bgSectionAppointment =
    data.allStrapiAcceptedInsurances.edges[0].node.SectionAppointment[0].url ||
    null
  ...
  return (
    <Layout>
      <SEO
        seo={
          data.allStrapiAcceptedInsurances.edges[0].node.SEO_Accepted_Insurances
        }
      />
